...
from lib.prior_generation import seen_previously_year_prior
import pandas as pd

with description('seen_previously_year_prior') as self:
    with before.each:
        self.args = {}
    ...
    with context('when year is 1983'):
        ...
        with context('and row is [1, 0, 0, 0, 0, 0] starting at 1980'):
            ...
            with it('should return a strong prior saying yes'):
                self.rv = seen_previously_year_prior(**self.args)
